...
from components.acp          import afficher_section_acp
...
.stTabs [data-baseweb="tab"] { height: 44px; padding: 0 20px; border-radius: 8px 8px 0 0; font-weight: 600; font-size: 0.9rem; }
</style>
...
st.markdown("<div class='main-subtitle'>Comparez deux villes françaises sur leurs données générales, emploi, logement, météo, équipements, tourisme et enfin une analyse comparative.</div>", unsafe_allow_html=True)
...
with tabs[6]:
    afficher_section_acp(ville1, ville2)
